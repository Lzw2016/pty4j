...
public class PtyHelpers {
    ...
    public interface OSFacade {
         ...
         * stores the results in the given {@link org.pty4j.WinSize} structure.
         *
    ...
    static {
        if (Platform.isMac()) {
            myOsFacade = new org.pty4j.unix.macosx.OSFacadeImpl();
        } else if (Platform.isFreeBSD()) {
            myOsFacade = new org.pty4j.unix.freebsd.OSFacadeImpl();
        } else if (Platform.isOpenBSD()) {
            myOsFacade = new org.pty4j.unix.openbsd.OSFacadeImpl();
        } else if (Platform.isLinux()) {
            myOsFacade = new org.pty4j.unix.linux.OSFacadeImpl();
