...
public class NativePtyExecutor implements PtyExecutor {
    ...
    NativePtyExecutor(String libname) {
    ...
    public interface Pty4J extends com.sun.jna.Library {
        int exec_pty(String full_path, String[] argv, String[] envp, String dirpath, String pts_name, int fdm, String err_pts_name, int err_fdm, boolean console);
    }
}
